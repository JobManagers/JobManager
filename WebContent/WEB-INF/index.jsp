	...
	<body class="wid_1130" style="background: #edf0f2 url(img/left_bg.jpg) repeat-y 0px 0px;overflow: hidden;" >
		...
		<div id="mainFrame" style="" >
					...
					<ul class="first_left">
						<li class="on">
						   ...
						   <ul class="second_left" style="display:block">
						      	<li class="health_report"><a href="files/book_list.jsp" target="mainf"><i class="icon_account"></i><span>员工列表</span></a></li>			
						...
						<li class="on">
						   ...
						   <ul class="second_left" style="display:block">
						      	<li class="health_report"><a href="files/shift_plan_list.jsp" target="mainf"><i class="icon_account"></i><span>排班方案管理</span></a></li>
								<li class="health_report"><a href="files/shift_table_list.jsp" target="mainf"><i class="icon_account"></i><span>排班表管理</span></a></li>
			...
			<div class="right_main fl" >
	            ...
	            <div id="div_pannel">
	            	<iframe src="files/book_list.jsp" frameborder="0" width="100%" height="100%" name="mainf" id="mainf" border="0"></iframe>
	            </div>
			</div>
        </div>
