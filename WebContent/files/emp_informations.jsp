...
<body>
	<body>
		...
		<!--遮罩层 end-->
		<!--系统提示-->
		<div class="zhy_popa mem_choose_search"
			style="width: 725px; margin-left: -363px;">
			<p class="color66">
				系统提示 <span class="pull-right close_icon" onclick="hidePop()"></span>
			</p>
			<div class="pop_content">
				<form class="form-inline" role="form">
					<div class="form-group">
						<div class="search ">
							<input type="text" placeholder="请输入需要查询的会员姓名/会员编号/手机号"
								class="font14" /> <input style="display: none">
						</div>
					</div>
					<div class="form-group">
						<button type="button" class="btn btn_white20">搜索</button>
					</div>
				</form>
			</div>
			<div class="text-center color333 font18 "
				style="margin-bottom: 80px; margin-top: 80px;">请在搜索框内输入需要绑定的会员信息</div>
		...
		<div class="zhy_popa mem_choose_zero"
			style="width: 725px; margin-left: -363px;">
			<p class="color66">
				系统提示 <span class="pull-right close_icon" onclick="hideEdit()"></span>
			</p>
			<div class="pop_content">
				<form class="form-inline" role="form">
					<div class="form-group">
			...
			<div class="text-center color333 font18 "
				style="margin-bottom: 10px; margin-top: 80px;">抱歉，未搜索到相关会员，请您检查输入内容</div>
		...
		<div class="zhy_popa mem_choose"
			style="width: 725px; margin-left: -363px;">
			<p class="color66">
				系统提示 <span class="pull-right close_icon" onclick="hidePopC()"></span>
			</p>
			<div class="pop_content">
				<form class="form-inline" role="form">
					<div class="form-group">
	      ...
	      <tr> 
			...
			<div class="text-center">
				<div id="Pagination" class="pagination">
					<a class="prev" href="#">上一页</a><a href="#">1</a><a href="#">2</a><span
						class="current">3</span><a href="#">4</a><span>...</span><a
						href="#">8</a><a class="next" href="#">下一页</a>
				</div>
			</div>
			<div class="clear" style="height: 20px;"></div>
		</div>
